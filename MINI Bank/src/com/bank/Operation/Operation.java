...
public class Operation {
	...
	// Metod used for account creation
	...
	public void depositMoney() {
		...
		if (ac1 != null) {
			...
			if (amount > 0) {
				...
				Query<Customer> hql = sn.createQuery("update Customer set balance=:amount where AccountNumber=:accno");
